...
0
|| checktplrefresh('data/diy/./template/dean_source_170511//forum/viewthread.htm', './template/dean_source_170511/forum/viewthread_node.htm', 1519376365, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/dean_source_170511/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/dean_source_170511//forum/viewthread.htm', './template/dean_source_170511/forum/viewthread_fastpost.htm', 1519376365, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/dean_source_170511/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/dean_source_170511//forum/viewthread.htm', './template/dean_source_170511/forum/viewthread_node_body.htm', 1519376365, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/dean_source_170511/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/dean_source_170511//forum/viewthread.htm', './template/default/common/seditor.htm', 1519376365, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/dean_source_170511/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/dean_source_170511//forum/viewthread.htm', './template/default/forum/seccheck_post.htm', 1519376365, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/dean_source_170511/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/dean_source_170511//forum/viewthread.htm', './template/default/common/upload.htm', 1519376365, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/dean_source_170511/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/dean_source_170511//forum/viewthread.htm', './template/default/common/seccheck.htm', 1519376365, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', 'data/diy/./template/dean_source_170511/', 'forum/viewthread')
;
block_get('66,67,68,69,72');?><?php include template('common/header'); $ucthread = C::t('forum_thread')->fetch_all_by_authorid($_G['forum_thread']['authorid'], 0,8);?><?php $ucauthor = DB::fetch_first("SELECT `follower`,`threads`,`following` FROM ".DB::table('common_member_count')." WHERE uid = ".$_G['forum_thread']['authorid']);?><script type="text/javascript">var fid = parseInt('<?php echo $_G['fid'];?>'), tid = parseInt('<?php echo $_G['tid'];?>');</script>
